...
(function() {
  ...
  Application = (function(_super) {
    ...
    Application.prototype.initialize = function(options, cb) {
      ...
      $(function() {
        ...
        $(document).on('inserted', function(evt, res, options) {
          ...
          loglet.log('a.click', this, app.isExternalURL(href));
    ...
    Application.prototype.setPageMode = function(mode) {
      $ = this.$;
      this.pageMode = mode;
      if (this.pageMode === 'modal') {
        return $(this.options.modalID).modal({
          show: true,
          keyboard: true,
          backdrop: true
        });
      } else {
        return $(this.options.modalID).modal('hide');
      }
    };
